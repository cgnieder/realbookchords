...
% arara: xelatex
% arara: biber
% arara: makeindex: { sort: true, style: realbookchords_en.ist }
% arara: xelatex
% arara: xelatex
% --------------------------------------------------------------------------
...
\docsetup{
  pkg      = [load-musixtex]realbookchords ,
  code-box = {
...
\setsansfont[Ligatures=TeX,RawFeature=+onum]{Linux Biolinum O}
}
...
\section{Song Titles}
\begin{beschreibung}
 \Befehl{SongTitle}[<left>]{<center>}\oa{<right} \cnpkgdocarrow
